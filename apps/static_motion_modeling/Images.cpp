...
int main(int argc, char **argv)
{
	...
	experiment.add_test<dataset::Image>(input_path + "/test");
	float t_obj = 0.75;
	float t_obj1 = 0.75;
	float t_obj2 = 0.75;
	float th_lr = 1.0f;
	...
	// conv1.parameter<uint32_t>("epoch").set(400);
	...
	// auto &conv2 = experiment.push<layer::Convolution>(5, 5, 32);
	...
	// conv2.parameter<uint32_t>("epoch").set(400);
	...
	fc1.parameter<uint32_t>("epoch").set(400);
